...
INSERT INTO timetable_lesson
(id_timetable_lesson, class_id, teacher_id, subject_id, weekday, lesson_no, room)
VALUES
(1, 1, 1, 1, 1, 1, '101'),
(2, 1, 2, 2, 1, 2, '102'),
(3, 1, 2, 3, 2, 1, '102'),
...
SET s.last_grade_at = (
  ...
  FROM grade g
  WHERE g.student_id = s.id_student
)
WHERE s.id_student > 0;
